      ...
      <div className="max-w-xl mx-auto p-8 bg-white rounded-lg shadow space-y-6 border border-gray-300">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            readOnly
            className="block w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 cursor-not-allowed text-gray-500"
          />
        </div>

        <h3 className="text-purple-700 font-semibold border-b border-gray-300 pb-2 mt-8 mb-4">
          개인 정보 수정
        </h3>
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button
              className="px-3 py-1 border border-purple-600 rounded-md text-purple-600 hover:bg-purple-50 transition whitespace-nowrap"
              variant="outline"
            >
              변경
            </Button>
